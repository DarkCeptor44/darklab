...
// @version      1.0
// @description  Adds some useful stuff to Twitch like T for Theather mode instead of Alt+T and E for opening/closing chat
// @author       DarkCeptor44
...
(function () {
    ...
    var style = '' +
        ...
        `*::selection,.seekbar-segment.tw-absolute{background-color:${accent} !important;}` +
