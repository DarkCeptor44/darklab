...
// @history      1.3 Small adjustments
// @history      1.4 More stuff
// @downloadURL  https://darkceptor44.github.io/darklab/assets/userscripts/dark-twitch.user.js
// @updateURL    https://darkceptor44.github.io/darklab/assets/userscripts/dark-twitch.user.js
// ==/UserScript==
...
(function () {
    ...
    var style = '@keyframes rainbow{0%{background-position:0% 50%}50%{background-position:100% 25%}100%{background-position:0% 50%}}@-webkit-keyframes rainbow{0%{background-position:0% 50%}50%{background-position:100% 25%}100%{background-position:0% 50%}}@-moz-keyframes rainbow{0%{background-position:0% 50%}50%{background-position:100% 25%}100%{background-position:0% 50%}}@-o-keyframes rainbow{0%{background-position:0% 50%}50%{background-position:100% 25%}100%{background-position:0% 50%}}@-ms-keyframes rainbow{0%{background-position:0% 50%}50%{background-position:100% 25%}100%{background-position:0% 50%}}' +
        ...
        `.tw-core-button--primary,.tw-toggle__input:checked+.tw-toggle__button,.jCxFvU{transition:100ms ease;background-color:${accent} !important;}` +
        `.tw-root--hover .jCxFvU:hover,.tw-core-button--primary, .tw-segmented-button-option__input--checkbox:checked+.tw-segmented-button-option__label, .tw-segmented-button-option__input--radio:checked+.tw-segmented-button-option__label{background-color:${accent_light} !important;}`+
    ...
    timers.t3=setInterval(function(){
        if(location.pathname==='/') location.href='/directory/following/live';
    },200);
            ...
            case 'M':
                ...
                if(player!==null){
                    if(player.volume>0&&player.volume<=1){
                        ...
                        fancyLog('Muted internally');
                    }
                    else{
                        player.volume=1;
                        fancyLog('Unmuted internally');
                    }
                }
                break;
            case 'x':
